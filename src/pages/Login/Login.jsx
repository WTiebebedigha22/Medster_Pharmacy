...
import { faEye, faEyeSlash, faSpinner, faShieldAlt, faCheckCircle, faUser } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className={styles.container}>
        ...
        <div className={styles.formPanel}>
          <div className={styles.formContainer}>
            ...
            <p className={styles.formSubtitle}>Sign in to access your prescriptions and manage your health</p>
            ...
            <form onSubmit={handleSubmit} className={styles.form}>
              ...
              <div className={styles.formGroup}>
                ...
                <div className={styles.passwordField}>
                  <input
                    ...
                    required
                  />
                  <button type="button" className={styles.showButton} onClick={togglePassword} aria-label={showPassword ? "Hide" : "Show"}>
              ...
              <div className={styles.formOptions}>
                ...
                <Link to="/auth/reset-password" className={styles.forgotLink}>Forgot password?</Link>
              </div>

              <button type="submit" className={styles.submitBtn} disabled={loading}>
                {loading ? <><FontAwesomeIcon icon={faSpinner} spin /> Signing in...</> : 'Sign In'}
              </button>
            </form>
            ...
            <div className={styles.signupPrompt}>
              ...
              <Link to="/auth/register" className={styles.signupLink}>Create Account</Link>
            </div>
          </div>
