...
SELECT 
  id,
  'super_admin',
  '["products.manage","orders.manage","users.manage","admins.manage","prescriptions.manage","coupons.manage","reports.view","settings.manage","audit.view","inventory.manage","categories.manage"]'::jsonb
FROM users 
WHERE email = 'admin@medster.com'
ON CONFLICT (user_id) DO UPDATE 
SET role_label = 'super_admin', 
    permissions = '["products.manage","orders.manage","users.manage","admins.manage","prescriptions.manage","coupons.manage","reports.view","settings.manage","audit.view","inventory.manage","categories.manage"]'::jsonb;
...
CREATE TRIGGER IF NOT EXISTS prescriptions_updated_at
...
--   1. node scripts/seed-products-direct.js   (469 products)
--   2. node scripts/seed-sample-orders.js     (12 sample orders)
--
-- Then login with:
